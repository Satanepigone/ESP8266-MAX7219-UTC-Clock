...
void loop() 
{
	...
	bool updown = true;		//vertical scroll direction: true=up-2-down; false=down-2-up
...
//00:20自动同步，注意此处不能设为00:00；不然需要修改loop()开头处的初始值
		...
		if (f_tckr50ms == true) 
		{
			...
			if (sc1 == 1) 
			{
				...
				char22Arr(48 + sec_ones_now, t_PosX + 30, y3);
				char22Arr(48 + sec_ones_old, t_PosX + 30, y + y1);
				if (y == 0) 
				{
					sc1 = 0;
					f_scrollend_y = true;
				...
				char22Arr(48 + sec_ones, t_PosX + 30, 0);

			if (sc2 == 1) 
			{
				char22Arr(48 + sec_tens_now, t_PosX + 26, y3);
				char22Arr(48 + sec_tens_old, t_PosX + 26, y + y1);
				if (y == 0)
					sc2 = 0;
			}
			else
			  char22Arr(48 + sec_tens, t_PosX + 26, 0);
			...
			char2Arr(WD_arr[MEZ.WD][0], d_PosX + 29, 0);			//day of the week
			char2Arr(WD_arr[MEZ.WD][1], d_PosX + 35, 0);
			char2Arr(WD_arr[MEZ.WD][2], d_PosX + 41, 0);
