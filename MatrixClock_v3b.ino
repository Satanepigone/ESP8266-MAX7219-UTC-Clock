...
const unsigned char alarm_min_onessecREG = 0x07;
const unsigned char alarm_min_onesminREG = 0x08;
const unsigned char alarm_min_oneshrREG = 0x09;
const unsigned char alarm_min_onesdateREG = 0x0A;
const unsigned char alarm_min_tensminREG = 0x0B;
const unsigned char alarm_min_tenshrREG = 0x0C;
const unsigned char alarm_min_tensdateREG = 0x0D;
	...
	while (true) {
		...
		if (f_tckr50ms == true) {
			...
			if (sc1 == 1) {
			   ...
			   char22Arr(48 + sec_ones_now, z_PosX - 27, y3);
			   char22Arr(48 + sec_ones_old, z_PosX - 27, y + y1);
				if (y == 0) {
					sc1 = 0;
					f_scrollend_y = true;
				}
				...
				char22Arr(48 + sec_ones, z_PosX - 27, 0);

			if (sc2 == 1) {
				char22Arr(48 + sec_tens_now, z_PosX - 23, y3);
				char22Arr(48 + sec_tens_old, z_PosX - 23, y + y1);
				if (y == 0)
					sc2 = 0;
			}
			else
			...
			if (sc3 == 1) {
				char2Arr(48 + min_ones_now, z_PosX - 18, y);
				char2Arr(48 + min_ones_old, z_PosX - 18, y + y1);
				if (y == 0)
					sc3 = 0;
			}
			else
				char2Arr(48 + min_ones, z_PosX - 18, 0);

			if (sc4 == 1) {
				char2Arr(48 + min_tens_now, z_PosX - 13, y);
				char2Arr(48 + min_tens_old, z_PosX - 13, y + y1);
				if (y == 0)
					sc4 = 0;
			}
			else
			...
			if (sc5 == 1) {
				char2Arr(48 + hr_ones_now, z_PosX - 4, y);
				char2Arr(48 + hr_ones_old, z_PosX - 4, y + y1);
				if (y == 0)
					sc5 = 0;
			}
			else
				char2Arr(48 + hr_ones, z_PosX - 4, 0);

			if (sc6 == 1) {
				char2Arr(48 + hr_tens_now, z_PosX + 1, y);
				char2Arr(48 + hr_tens_old, z_PosX + 1, y + y1);
				if (y == 0)
					sc6 = 0;
			}
			else
				char2Arr(48 + hr_tens, z_PosX + 1, 0);
